...
def cadastro_medico(request):
    ...
    if is_medico(request.user):
        ...
        return redirect('/medicos/abrir_horario') # proxima configuração
    ...
    if request.method == "GET":
        ...
        return redirect('/medicos/abrir_horario') # proxima codificação


 # O Usuario tem que está logado
def abrir_horario(request):
    # Só usuarios definidos como medico
...
def finalizar_consulta(request, id_consulta):
    ...
    if request.user != consulta.data_aberta.user:
        ...
        return redirect(f'/medicos/abrir_horariorios/')
